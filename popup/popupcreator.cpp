...
void PopUpCreator::victory(int score) {
    ...
    line << "As you smash the second altar, all the monsters immediately turn to dust. You arise from the cave (after "
         ...
         "them for exhorbitant prices. You saved the world and destroyed the capitalist plot!\n\n"
         "Score: " << score;
    PopUp::make(line.str());
}
    ...
    switch(l) {
        case 1:
            line << "One month ago, monsters long thought extinct began appearing around your town. As more and more "
                ...
                "were the only fighter around. After days of travel, you entered the cave.";
            break;
        case 2:
            line << "After days of near constant fighting, you managed to descend to the next level. Instead of another "
                "dungeon, you find yourself in a giant cave. You notice that as you go further into the earth, the "
                "monsters seen to become stronger. You also notice that merchant's guild has somehow gained a "
        ...
        case 3:
            line << "Weeks pass before you find the staircase to the next level, and after climbing down for half an hour, you "
                ...
                "convince the non-existant monster government that creating a town would stabilize the economy and "
